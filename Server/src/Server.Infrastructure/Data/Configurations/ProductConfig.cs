...
internal class ProductConfig : TimeStampConfigurationBase<PersistenceModels.Product>
{
    public override void Configure(EntityTypeBuilder<PersistenceModels.Product> builder)
    {
